...
Ви введете при реєстрації нового користувача - вже занятий логін. :necktie: \
Якщо ви спробуєте міняти дані інших користувачів, а не свої. :necktie: \
Якщо при авторизації напишите не той логін чи пароль :necktie:
